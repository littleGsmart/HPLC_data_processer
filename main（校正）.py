...
name_list = ['dmas1.txt','dmas2.txt']
cr_table = np.load('cr_table.npy')
for name in tqdm(name_list):
    HPLC = HPLC_data('data\\'+name,name=name.split('.')[0])
    # HPLC.abs_table = HPLC.abs_table - cr_table
...
# Correct = HPLC_data('data\\dmas1.txt')
# n1 = Correct.abs_table.copy()
# Correct = HPLC_data('data\\dmas2.txt')
# n2 = Correct.abs_table.copy()
# n = (n1+n2)/2
# np.save('cr_table.npy',n)